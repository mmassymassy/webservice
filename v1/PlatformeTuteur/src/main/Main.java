...
public class Main {
    public static void main(String[] args) throws RemoteException, MalformedURLException {
        ...
        IHoraire h1 = new Horaire("17/06/2024",10,00,12,00);
        IHoraire h2 = new Horaire("17/06/2024",14,00,18,00);
        IHoraire h3 = new Horaire("19/06/2024",8,00,10,00);

        IHoraire h4 = new Horaire("20/06/2024",8,00,10,00);
